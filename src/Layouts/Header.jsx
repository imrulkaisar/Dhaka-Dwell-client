 ...
 * Requirements:
 * **************
 * [Done] 1. Navbar has a logo+website name, Home, Apartment, and Login icon(conditional). If the user is logged in, his/her profile picture should appear on the navbar replacing the login icon.
 * [Done] 2. If the user clicks on the profile picture, a drop-down will appear with the following items: User name (not clickable), Dashboard, and Logout button.
 * 3.
 */
